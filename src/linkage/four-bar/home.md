...
- 連接桿 (Connecting rod): 也稱為浮桿 (floating link)，連接兩連桿（曲柄和搖桿或曲柄和滑塊），本身無固定軸，用以傳遞運動的連桿。
...
::: tip 死點
以曲柄當主動件，無論曲柄在任何位置都可以使搖桿擺動，但若以搖桿當作主動件，則當搖桿擺動到和從動件曲柄共線時，不加外力無法帶動曲柄，這種情況下的交點即稱為死點。
